...
writematrix([(200:1000)',median_0,median_1],strcat('result_f1.dat'),'delimiter','\t');
writematrix([[(200:1000)';(1000:-1:200)'],[lower_0;upper_0(end:-1:1)],[lower_1;upper_1(end:-1:1)]],strcat('result_f1_fill.dat'),'delimiter','\t');